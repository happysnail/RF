...
public class FileUtils 
{
	...
	protected static String[][] readBiDimensionalStringFromFile(String fileName) throws USVInputFileCustomException
	{
	...
	private static ArrayList<String> convertLineToLearningSetRow(String line)
	{
		...
		return new ArrayList<>(Arrays.asList(stringValues));
	}
